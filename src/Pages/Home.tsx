    ...
    <section className="w-[100%] min-height-[100vh]" id="home">
      ...
      <div className="w-[100%] h-[100%] z-50 relative pointer-events-none animate-fadeIn">
        ...
        <div className="w-[250px] h-[40px] md:pl-16 pl-10 mt-5">
          <button
            className="w-[100%] h-[100%] pointer-events-auto hover:cursor-pointer rounded-md border border-2 border-purple-700 text-gray-200 font-bold hover:bg-purple-700"
